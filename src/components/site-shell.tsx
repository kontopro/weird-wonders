  ...
  return (
    <div className="site-frame">
      <header className="site-header">
        <div className="header-inner">
          ...
          <div className="header-actions">
            ...
            <Button
              ...
              size="icon"
              onClick={toggleTheme}
              aria-label={dark ? "Φωτεινό θέμα" : "Σκούρο θέμα"}
            >
              {dark ? <Sun /> : <Moon />}
            </Button>
            <Button className="random-button" onClick={random}>
              <Shuffle /> Τυχαίο {siteConfig.contentLabels.singular}
            </Button>
            <Button
              variant="ghost"
              size="icon"
        ...
        {menu && (
          <nav className="mobile-nav" aria-label="Μενού κινητού">
            {nav.map(([label, to]) => (
      ...
      <footer className="site-footer">
        <div>
          <BrandLogo />
          <p>Κάθε μέρα κρύβει κάτι που δεν γνώριζες.</p>
        </div>
      ...
      {cookies && (
        <aside className="cookie-banner">
          <p>
            <strong>Μικρά cookies, μεγάλη περιέργεια.</strong>
            <br />
            Χρησιμοποιούμε μόνο απαραίτητα cookies για τη σωστή εμπειρία.
          </p>
          <Button
            onClick={() => {
